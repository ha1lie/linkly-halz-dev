  ...
  render() {
    return (
      <Box direction='column' flex='grow' margin='medium' style={{ minHeight: 'calc(100vh - 65pt)' }} >
        ...
        <ContactCard link='mailto:hallie@halz.dev' backColor='#5e5ce6' textColor='white' methodName='Email' methodIcon={ <Mail size='large' color='white' /> } actualContact='hallie@halz.dev' sellingPoint='Best for business inquiries, and opportunities to work with me' />
        ...
        <ContactCard link='https://twitter.com/h4l1ie' backColor='#5e5ce6' textColor='white' methodName='Twitter' methodIcon={ <Twitter size='large' color='white' /> } actualContact='@h4l1ie' sellingPoint='Best to stay up to date on my work and my thoughts' />
